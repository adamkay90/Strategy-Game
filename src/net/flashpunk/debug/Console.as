package net.flashpunk.debug
{
	...
	public class Console
	{
		...
		public function enable():void
		{
			...
			_butRead.addChild(_butDebug = new CONSOLE_DEBUG as Bitmap);
			_butRead.addChild(_butOutput = new CONSOLE_OUTPUT as Bitmap);
			_butRead.addChild(_butPlay = new CONSOLE_PLAY as Bitmap).x = 20;
			_butRead.addChild(_butPause = new CONSOLE_PAUSE as Bitmap).x = 20;
			_butRead.addChild(_butStep = new CONSOLE_STEP as Bitmap).x = 40;
			updateButtons();
